				...
				<div class="inner">
					...
					<?php if($file){ ?>
						<div class="single-download">
							<a href="<?php echo $file["url"] ?>" class="button button-big button-line-white" target="_blank">Descargar tutorial</a>
						</div>
					<?php }else{ ?>
						<div class="single-download">
							<a href="<?php the_permalink() ?>" class="button button-big button-line-white" target="_blank">Leer más</a>
						</div>
					<?php } ?>
